describe('Owner view tests', () => {
    ...
    it('should have a submit button to patch updates', () => {
        cy.fixture('singleTruck.json').then((truckDetails) => {
            ...
            cy.wait(500);
            cy.get('.name-input').type('You are Mistaken')
                .should('have.value', 'You are Mistaken')
            cy.get('.website-input').type('www.google.com')
                .should('have.value', 'www.google.com')
            cy.get('.input-photo').type('https://byjoandco.com/wp-content/uploads/2021/10/joana-godinho-Gwv-t9VQiPM-unsplash-1.jpg')
                .should('have.value', 'https://byjoandco.com/wp-content/uploads/2021/10/joana-godinho-Gwv-t9VQiPM-unsplash-1.jpg')
            ...
            cy.fixture('editTruck.json').then((editData) => {
                ...
                cy.wait('@newPatchEvent').its('response.statusCode').should('eq', 200);
            });
        });
